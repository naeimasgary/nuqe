...
const features: FeatureItem[] = [
  { icon: <ShieldIcon />, iconBg: "bg-rose-100", title: "Vetted Buyers Only", description: "Every buyer is admin-approved before accessing the platform, ensuring quality leads for sellers." },
  { icon: <CheckCircleIcon />, iconBg: "bg-teal-100", title: "Trust & Authenticity", description: "Reputation scores, verified credentials, and transaction history build trust without compromising privacy." },
  { icon: <EyeOffIcon />, iconBg: "bg-sky-brand-100", title: "Anonymous Communication", description: "Connect with verified partners while protecting your identity until you choose to reveal it." },
  { icon: <GridIcon />, iconBg: "bg-neutral-100", title: "Smart Directory", description: "Designed to expand across industries — from automation to energy, manufacturing, and beyond." },
];
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
        ...
        <div className="flex flex-col gap-8 lg:w-64 flex-shrink-0">
          <div className="flex flex-col gap-4">
            <h2 className="text-3xl font-bold text-text-default">Built for Industrial B2B</h2>
            <p className="text-text-secondary text-base leading-relaxed">
              Every feature designed to solve real problems in industrial procurement and vendor relationships.
            </p>
          </div>
          <button className="inline-flex items-center self-start text-sky-brand-600 text-sm font-semibold hover:text-sky-brand-800 transition-colors">
            Request a Callback →
          </button>
        </div>
